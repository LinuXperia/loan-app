    ...
    <div class="row">
        <div class="col-sm-10 offset-1">
            ...
            <div v-if="showSelf">
                ...
                <div class="alert alert-success text-centeredd" role="alert" v-if="saved">
            ...
            submit(){
                ...
                if(Vue.localStorage.get('userId') !== null){
                    ...
                    if(self.type == 'self'){
                        ...
                        axios.post('/borrower/borrower-self-employment-details', {
                        ...
                        //employed
                        axios.post('/borrower/borrower-work-details', {
