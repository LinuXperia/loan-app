    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" @submit.prevent="submit">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="type" id="type" class="form-control" v-bind:class="{ 'is-invalid': errors.type }" v-model="form.type">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number"  id="amount" class="form-control" v-bind:class="{ 'is-invalid': errors.amount }" v-model="form.amount">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number"  id="rate" class="form-control" v-bind:class="{ 'is-invalid': errors.rate }" v-model="form.rate">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="duration" class="form-control" v-bind:class="{ 'is-invalid': errors.duration }" v-model="form.duration" @change="calculateDuration" placeholder="Number of months">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="processing_fee" class="form-control" v-bind:class="{ 'is-invalid': errors.processing_fee }" v-model="form.processing_fee">
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="legal_fee" class="form-control" v-bind:class="{ 'is-invalid': errors.legal_fee }" v-model="form.legal_fee">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="car_track" class="form-control" v-bind:class="{ 'is-invalid': errors.car_track }" v-model="form.car_track">
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="car_track_maintenance" class="form-control" v-bind:class="{ 'is-invalid': errors.car_track_maintenance }" v-model="form.car_track_maintenance">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="logistics" class="form-control" v-bind:class="{ 'is-invalid': errors.logistics }" v-model="form.logistics">
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="kra_search" class="form-control" v-bind:class="{ 'is-invalid': errors.kra_search }" v-model="form.kra_search">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="mv" class="form-control" v-bind:class="{ 'is-invalid': errors.mv }" v-model="form.mv">
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number"  id="discharge_fee" class="form-control" v-bind:class="{ 'is-invalid': errors.discharge_fee }" v-model="form.discharge_fee">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea  id="remarks"  class="form-control" v-bind:class="{ 'is-invalid': errors.remarks }" v-model="form.remarks"></textarea>
...
<script>
    ...
    export default{
        props: ['borrowerDetails','agentDetails'],
        ...
        methods: {
            convertToJson(){
                this.borrower = JSON.parse(this.borrowerDetails)
        ...
        computed: {
            calculateLoan(){
                ...
                if(this.form.amount > 0){
                    totalAmount = totalAmount + parseInt(this.form.amount)
                }
