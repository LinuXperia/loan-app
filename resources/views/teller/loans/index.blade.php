        ...
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <div class="card-body text-center">
                    <div class="text-muted small text-uppercase font-weight-bold">Search Borrower</div>
                    <hr>
                    <div class="h2 py-3">
                        <ais-index app-id="{{ config('scout.algolia.id') }}"
                            ...
                            <ais-input placeholder="Search borrower..." class="form-control"></ais-input>
                                    ...
                                    <template slot-scope="{ result }">
                                        ...
                                        <div class="result">
                                            <a :href="result.user_id">
                                                ...
                                                <span class="title">Sur Name : </span> @{{ result.sname }}  |
