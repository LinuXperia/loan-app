                ...
                <div class="card-body">
                    ...
                    <div class="row loan-details">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    @if($loan->approved == true && $loan->approved_date !== '')
                                        <div class="alert alert-success text-center">{{ $loan->approved_date->toFormattedDateString() }}</div>
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    @if($loan->approved == true && $loan->approved_by !== '')
                    ...
                    <div class="row loan-details">
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-sm-4">
                                    <h5 class="text-dark"><Strong class="title">BORROWER: </Strong> </h5>
                    ...
                    <div class="row loan-details">
                        <div class="col-sm-4 offset-4">
                            <a href="{{ route('loan.payment', ['id' => $loan->id]) }}" class="btn btn-outline-info ">Add Payment</a>
                            <a href="#"  class="btn btn-outline-secondary">Print Loan</a>
                        </div>
                    </div>
                </div>
            </div>
